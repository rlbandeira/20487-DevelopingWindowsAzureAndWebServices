...
namespace BlueYonder.Companion.Client
{
    ...
    sealed partial class App : Application
    {
        ...
        private static string Tenant = "b2cmod11Lab[YourInitials].onmicrosoft.com";
        private static string ClientId = "[Application Id]";
        public static string PolicySignUpSignIn = "B2C_1_SignIn-Policy";

        public static string[] ApiScopes = { "https://b2cmod11Lab[YourInitials].onmicrosoft.com/api/read" };
        public static string ApiEndpoint = "http://B2CMod11Lab[YourInitials].azurewebsites.net/";
