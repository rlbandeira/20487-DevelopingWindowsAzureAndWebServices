...
19. Right-click project **BlueYonder.Companion.Functions** and point to **Add**, then click **Reference**. Select **Projects** and then add the below references and then click **OK**:
...
1. Right click the **BlueYonder.Companion.Functions** project, and then click **Publish**.  
   ...
   Select **Azure Functions App**, make sure **Create New** is selected, and then click **Create Publish**
