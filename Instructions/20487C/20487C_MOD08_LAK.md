...
17. In the **Pick a Publish** target dialogue box select **App Service** and make sure **Create New** is selected, and then click **Publish**.
...
10. In the **Pick a Publish** target dialogue box select **App Service** and make sure **Create New** is selected, and then click **Publish**.
...
5. In the **Pick a Publish** target page, select **IIS, FTP, etc.**, and then click **Publish**.
...
9. In the **Pick a Publish** target page, select **IIS, FTP, etc.**, and then click **Publish**.
