...
13. Replace the following information: 
    ...
    - In the **ClientSecret** text box, replace with the value copied from Exercise 1, Task 2, Step 11.
14. In **BlueYonder.Companion.Host**, expand **App_Start**, and then click **Startup.Auth.cs**.
...
18. Click **LocationsController**, and add an **[Authorize]** attribute to the class.
...
8.  Click **Addresses**, locate **BaseUri** property, and replace **YourInitials** with your initials.
